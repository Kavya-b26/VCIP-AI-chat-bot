# VCIP AI Chatbot — RAG-based Onboarding Assistant

**95% accuracy · Zero human intervention · Built on AWS Bedrock**
...
| [Other metric — e.g. avg response time, drop-off reduction, CSAT] | [value] |

## 🧠 What I Learned
[1–3 sentences — a real lesson, not a platitude. e.g. a tradeoff you made between accuracy and latency, or how compliance review shaped the scope.]
